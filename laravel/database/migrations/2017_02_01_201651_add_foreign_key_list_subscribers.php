...
class AddForeignKeyListSubscribers extends Migration {
    ...
    public function up() {
        Schema::table('list_subscribers', function (Blueprint $table) {
            $table->foreign('list_id', 'FK_list_subscribers_lists')->references('id')->on('lists');
    ...
    public function down() {
        Schema::table('list_subscribers', function (Blueprint $table) {
            $table->dropForeign('FK_list_subscribers_lists');
            $table->dropForeign('FK_list_subscribers_subscribers');
        });
    }
